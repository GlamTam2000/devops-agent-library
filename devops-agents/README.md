...
## Porting to Lloyds (or any enterprise GitHub)

Before you open the PR that adds this to a work repo, ask the GitHub org admin **one** question:

> *"For repos in our org, which models appear in the GitHub Models catalogue when a workflow declares `permissions: models: read`?"*

Their answer tells you what to put in `.agentsrc.yml`. Three scenarios:
...
### What to put in front of InfoSec

The audit log and this README are designed so you can hand them both over as evidence that:
